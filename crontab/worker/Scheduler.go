...
// 尝试执行任务
func (scheduler *Scheduler) TryStopJob(jobPlan *common.JobSchedulePlan) {
	var (
		jobExecuteInfo *common.JobExecuteInfo
		jobExecuting   bool
	)
	...
	// 执行的任务可能运行很久, 1分钟调度60，但是只能执行1次,防止并发
